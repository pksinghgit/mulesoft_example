...
/**
 * A <code>CustomSDKConnectorrConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link CustomSDKConnectorrConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-02-20T10:08:50+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class CustomSDKConnectorrConnectorLifecycleInjectionAdapter
    extends CustomSDKConnectorrConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(CustomSDKConnectorrConnectorLifecycleInjectionAdapter.class);
