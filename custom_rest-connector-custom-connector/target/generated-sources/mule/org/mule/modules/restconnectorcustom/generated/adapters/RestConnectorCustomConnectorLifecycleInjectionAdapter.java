...
/**
 * A <code>RestConnectorCustomConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link RestConnectorCustomConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-02-20T05:08:25+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class RestConnectorCustomConnectorLifecycleInjectionAdapter
    extends RestConnectorCustomConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(RestConnectorCustomConnectorLifecycleInjectionAdapter.class);
