...
/**
 * A <code>CustomonnConnectorMetadataAdapter</code> is a wrapper around {@link CustomonnConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-11-20T09:42:04+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class CustomonnConnectorMetadataAdapter
    extends CustomonnConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "Customonn";
